<%-- 
    Document   : unshippedItems
    Created on : 14 Jan, 2025, 3:53:39 PM
    Author     : ashmi
--%>
...
<html>
    ...
    <body style="background-color: #E6F9E6;">
        ...
        <div class="text-center text-primary h3 m-3">Un-Shipped Orders</div>
            ...
            <div class="table-responsive ">
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><%=transId%></td>
                            <td><a href="./updateProduct.jsp?prodid=<%=productId%>"><%=productId%></a></td>
                            <td><%=userId%></td>
                            <td><%=userAddr%></td>
                            <td><%=quantity%></td>
                            <td>READY_TO_SHIP</td>
                            <td><a
                                    href="ShipmentServlet?orderid=<%=order.getOrderId()%>&amount=<%=order.getAmount()%>&userid=<%=userId%>&prodid=<%=order.getProductId()%>"
